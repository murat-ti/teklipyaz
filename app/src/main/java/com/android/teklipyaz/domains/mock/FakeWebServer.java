...
public class FakeWebServer {
    ...
    public void addCategory() {
        ...
        /*ArrayList<OrganizationCategory> listOfCategory = new ArrayList<OrganizationCategory>();

        listOfCategory
                .add(new OrganizationCategory(
                        "Electronic",
                        "Electric Items",
                        "10%",
    ...
    public void getAllElectronics() {
        ...
        ConcurrentHashMap<String, ArrayList<OrganizationModel>> organizationMap = new ConcurrentHashMap<String, ArrayList<OrganizationModel>>();

        ArrayList<OrganizationModel> organizationlist = new ArrayList<OrganizationModel>();
        ...
        organizationMap.put("Microwave oven", organizationlist);

        ArrayList<OrganizationModel> tvList = new ArrayList<OrganizationModel>();

        // TV
        tvList.add(new OrganizationModel(
                "LED",
        ...
        organizationMap.put("Television", tvList);

        organizationlist = new ArrayList<OrganizationModel>();
        ...
        organizationMap.put("Vaccum Cleaner", organizationlist);*/


        CenterRepository.getCenterRepository().setMapOfOrganizationsInCategory(organizationMap);
    ...
    public void getAllFurnitures() {
        ...
        organizationMap.put("Tables", organizationlist);
        ...
        organizationMap.put("Chairs", organizationlist);
        ...
        organizationMap.put("Almirah", organizationlist);
    ...
    public void getAllOrganizations(int organizationCategory) {

        if (organizationCategory == 0) {
